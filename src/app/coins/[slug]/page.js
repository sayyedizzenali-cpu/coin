...
export const revalidate = 60
 ...
 export async function generateStaticParams() {
  return [
    {slug:'bitcoin'},{slug:'ethereum'},{slug:'binancecoin'},
    {slug:'solana'},{slug:'ripple'},{slug:'cardano'},
    {slug:'dogecoin'},{slug:'avalanche-2'},{slug:'polkadot'},
    {slug:'chainlink'},{slug:'litecoin'},{slug:'shiba-inu'},
    {slug:'tron'},{slug:'near'},{slug:'cosmos'},
    {slug:'uniswap'},{slug:'aave'},{slug:'maker'},
  ]
}
