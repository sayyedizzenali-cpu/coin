...
export async function generateStaticParams() {
  const topCoins = ['bitcoin','ethereum','binancecoin','solana','ripple','cardano','dogecoin','avalanche-2','polkadot','chainlink','litecoin','bitcoin-cash','stellar','tron','near','cosmos']
